...
class AccountList(Screen):
    ...
    def __dbFilePath(self):
        dataDir = Path(App.get_running_app().user_data_dir)
        dataDir.mkdir(parents=True, exist_ok=True)
        return dataDir / 'accountList.sqlite3'
    ...
    def generatePassword(self, **kwargs):
        ...
        # 포커스된 행의 3번째 열(pswd) 위젯 찾아 password로 교체
